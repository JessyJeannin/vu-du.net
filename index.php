...
<h1 class="title1" id="news">Dernières nouvelles</h1>
            ...
            <div class="row-news-card" id="_news">
                <div class="news-card">
                    <a href="#"><span class="card-suite">Lire la suite <i class="fas fa-arrow-right"></i></span></a>
                    <div class="card-date">
                    ...
                    <div class="card-thumb">
                        <img src="images/vitrine_web.png" alt="">
                    </div>

                    <div class="card-body">
                        <h2>Qu’est-ce qu’une « Vitrine Web » Vu-Du.Net ?</h2>
                        <p>Une Vitrine Web est par définition votre présentation net-te de votre entreprise. Peu importe le chiffre d’affaire, le nombre de salariés, la localisation de vos locaux…sur le Net, toutes les …</p>
                ...
                <div class="news-card">
                    ...
                    <div class="card-thumb">
                        <img src="images/horse-21.jpg" alt="">
                    </div>

                    <div class="card-body">
                        <h2>Vous êtes … une écurie</h2>
                        <p>En campagne, on apprécie la Nature, les espaces, le calme. Une des facettes les plus appréciés par les touristes dans nos campagnes est la possibilité du faire de l’équitation…c’est une …</p>
                        <div class="card-social">
                            <i class="fab fa-facebook-f"></i>
                            <i class="fab fa-twitter"></i>
                            <i class="fab fa-pinterest-p"></i>
